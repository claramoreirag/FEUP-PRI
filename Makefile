...
all: fake_clean.csv article.csv thread.csv website.csv author.csv fake.db
...
article.csv thread.csv website.csv author.csv: fake_clean.csv
	python split.py
...
fake.db: article.csv thread.csv website.csv author.csv
	python to_sqlite.py
	echo "Database created, fake.db ready"

clean:
	rm -f fake_clean.csv article.csv thread.csv website.csv author.csv